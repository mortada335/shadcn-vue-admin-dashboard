...
import AppInput from '../fields/AppSliderField.vue';
import { SliderInputProps } from '../fields/types';
import { FormRegisterInjectionKey, FormUnregisterInjectionKey, Validated, FieldValidation } from './types';

const props = defineProps<Validated & SliderInputProps>()
...
<template>
  <AppInput :disabled :label :placeholder :max :min :step :id v-model="model">
